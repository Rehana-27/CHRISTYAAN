...
const ListMeditations = ({ meditations, loading, onDelete, currentPage, numPages, onPageChange }: Props) => {
                        ...
                        <div className={`flex rounded dark:bg-dark-900 border items-center overflow-hidden`}>
                          ...
                          >
                            ...
                            <ListActionsPopover
                              onDelete={onDelete}
                              itemId={item.id}
                              pathEdit={`/meditations/meditations-edit/?id=${item.id}`}
                              pathView={`/meditations/meditations-view/?id=${item.id}`}
...
export default ListMeditations
