...
const CardMeditations = ({
  ...
  return (
    <div className={'p-4'}>
      ...
      >
        {!loading && meditations.map((item, index) => (
          <li
            key={item.id}
          ...
          >
              <Link href={`/meditations/meditations-view/?id=${item.id}`} className='text-lg font-bold leading-6 line-clamp-1'>
                  {item.title}
              </Link>
...
export default CardMeditations;
