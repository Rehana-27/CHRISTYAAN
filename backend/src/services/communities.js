...
module.exports = class CommunitiesService {
  ...
  static async update(data, id, currentUser) {
    const transaction = await db.sequelize.transaction();
    try {
      let communities = await CommunitiesDBApi.findBy(
        {id},
        {transaction},
      );
      ...
      const updatedCommunities = await CommunitiesDBApi.update(
        id,
        data,
        {
          currentUser,
